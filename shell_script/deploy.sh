...
then
    ...
    /usr/local/bin/aws lambda create-function --function-name kjs-testtest --runtime python3.10 --role arn:aws:iam::686449765408:role/storelink --handler lambda_function.lambda_handler --region $REGION
